...
class DFlashDraftRunner:
    ...
    def speculate(
        ...
        *,
        ...
        with nvtx_range(f"dflash_draft_prepare{sfx}", generic="dflash_draft_prepare"):
        ...
        with nvtx_range(
            f"dflash_draft_precompute{sfx}", generic="dflash_draft_precompute"
        ):
        ...
        with nvtx_range(f"dflash_draft_forward{sfx}", generic="dflash_draft_forward"):
